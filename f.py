...
psb('\x1b[1;31mSTART PLEASE WAIT ..........')
time.sleep(3)
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}BD RANDOM')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}1.0.9')
    
    print(f"{M}╔══[{H}[{M}1{H}] \033[1;92mRANDOM BD 06 DIGIT{RED}")
    print(f"║══[{H}[{M}2{H}] \033[1;92mRANDOM BD 07 DIGIT ")
    print(f"║══[{H}[{M}3{H}] \033[1;92mRANDOM BD 08 DIGIT {RED}")
    ...
    print(f"║══[{H}[{M}F{H}] \033[1;92mFOLLOW MY GITHUB {RED}")
    print(f"║══[{H}[{M}Y{H}] \033[1;92mFOLLOW MY FB PAGE {RED}")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio DEVIL_OK.mp3")
                print('    \033[1;92m[DEVIL🤘] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        DEVIL = random.choice(["\x1b[1;91DEVIL","\x1b[1;92mDEVIL","\x1b[1;93mDEVIL","\x1b[1;94mDEVIL","\x1b[1;95mDEVIL","\x1b[1;96mDEVIL","\x1b[1;97mDEVIL","\x1b[1;91mIRTAZA","\x1b[1;92mIRTAZA","\x1b[1;93mIRTAZA","\x1b[1;94mIRTAZA","\x1b[1;95mIRTAZA","\x1b[1;96mIRTAZA"])
        sys.stdout.write(f'\r    {P}[{DEVIL}{P}][{K}%s{P}/{B}%s{P}][{H}OK{P}]{P}[{H}%s{P}] \r'%(loop,tl,len(ok))),
        sys.stdout.flush()
    except:
        pass
